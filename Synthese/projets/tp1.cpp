...
Hit intersect_aux(const Scene &scene, const Point &o, const Vector &d, Source source)
{
    Hit plus_proche;
    plus_proche.t = inf;
...
Hit intersect_aux_dome(const Scene &scene, const Point &o, const Vector &d, Vector dir)
{
    Hit plus_proche;
    plus_proche.t = inf;
...
int main()
{
    ...
    Image image(1000, 1000); // par exemple...
